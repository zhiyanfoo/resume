...
\section{Experience}
  ...
  \resumeSubheading
    ...
    {Software Infrastructure Engineering Intern}{Jan 2021 - May 2021}
        \begin{itemize}[label={\textbullet}]
          \item Built tools to stress and loadtest cilium, our kubernetes cluster CNI (Container Network
            Interface), to check for performance regressions during upgrades.
          \item Built tools to help write and debug cilium network policies.
        \end{itemize}
  \resumeSubheading
