...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \courseItem
     {\textsc{Languages -- } Python, Typescript, Haskell, Rust, C/C++}
   \courseItem
     {\textsc{Tech/Frameworks -- } *Nix, React/Redux, Flask, Django, Express, MySQL, PostgreSql,
     \LaTeX, Git, AWS(EC2, S3) }
